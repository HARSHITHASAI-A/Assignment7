...
document.write("Half of "+number_1+" is "+halfNumber(number_1)+".");
...
var square;
 ...
 document.writeln("The result of squaring the number " + number + " is " + squareNumber(number)+".");
...
document.writeln(number_1+" is "+percentOf(number_1,number_2)+"% of "+number_2+".");
...
var number_1 = parseInt(prompt("Enter First Number :"));
var number_2 = parseInt(prompt("Enter Second Number :"));
document.writeln(findModulus(number_1,number_2)+" is the modulus of "+number_1+" and "+number_2+".");
...
document.writeln("Sum of " +arr+ " is "+ans+".");